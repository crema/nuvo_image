...
if (UNIX AND NOT APPLE)
  ...
  set(MOZJPEG_LIBRARIES ${EXTERNAL_LIB_DIR}/mozjpeg/lib/libjpeg.so)
else ()
  set(MOZJPEG_LIBRARIES ${EXTERNAL_LIB_DIR}/mozjpeg/lib/libjpeg.dylib)
endif()

set(WITH_JPEG ON CACHE BOOL "")
set(BUILD_JPEG OFF CACHE BOOL "")
set(JPEG_INCLUDE_DIR ${EXTERNAL_LIB_DIR}/mozjpeg/include CACHE PATH "")
set(JPEG_LIBRARY ${MOZJPEG_LIBRARIES} CACHE FILEPATH "")

set(WITH_FFMPEG ON CACHE BOOL "")
set(FFMPEG_INCLUDE_DIR ${EXTERNAL_LIB_DIR}/ffmpeg-3.1.1/include CACHE PATH "")
set(FFMPEG_LIB_DIR ${EXTERNAL_LIB_DIR}/ffmpeg-3.1.1/lib CACHE PATH "")

set(CMAKE_INSTALL_PREFIX ${EXTERNAL_LIB_DIR}/opencv3.1.0 CACHE PATH "")
