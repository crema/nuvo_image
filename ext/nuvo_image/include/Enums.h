...
enum Flatten { None = -1, White, Black };

enum LossyImageFormat { InvalidLossyImageFormat = -1, Jpeg, LossyWebP };

enum LosslessImageFormat { InvalidLosslessImageFormat = -1, Png, LosslessWebP };

enum VideoFormat { InvalidVideoFormat = -1, Mp4, WebM };
